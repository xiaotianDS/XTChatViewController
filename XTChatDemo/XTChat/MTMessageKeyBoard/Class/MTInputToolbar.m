...
- (void)keyboardWillShow:(NSNotification *)notification
{
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(inputView:willShowKeyboardHeight:time:)]) {

        [_delegate inputView:self willShowKeyboardHeight:keyboardFrame.size.height time:[NSNumber numberWithFloat:duration]];
...
- (void)keyboardWillHidden:(NSNotification *)notification
{
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(willHideKeyboardWithInputView:time:)]) {

        [_delegate willHideKeyboardWithInputView:self time:[NSNumber numberWithFloat:duration]];
